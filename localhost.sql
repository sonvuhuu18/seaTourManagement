...
--
-- Host: localhost
-- Generation Time: Dec 15, 2016 at 04:25 PM
...
(9, 6, 'http://choidau.vn/upload/20150820010204-ho-guom-hoan-kiem1.jpg'),
...
(20, 15, 'http://newfocus.vn/Upload/images/thanh-dia-la-vang.jpg'),
...
CREATE TABLE `place_in_tour` (
  `place_in_tour_id` int(11) NOT NULL,
  `place_id` int(6) NOT NULL,
...
(2, 1, 1, 1, 1, '10:00:00', '20:00:00', 'Con chó Cường'),
(5, 1, 1, 2, 1, '10:10:00', '20:10:00', 'DDB');
...
(5, 'Hài Phòng đi Hà Nội', 1, 100000);
...
ALTER TABLE `place_in_tour`
  ...
  ADD UNIQUE KEY `con_cho_cuong` (`tour_id`,`order_number`),
...
--
ALTER TABLE `place_in_tour`
  MODIFY `place_in_tour_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tour`
--
ALTER TABLE `tour`
  MODIFY `tour_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `place_in_tour`
  ADD CONSTRAINT `fk_place_id` FOREIGN KEY (`place_id`) REFERENCES `place` (`place_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tour_id` FOREIGN KEY (`tour_id`) REFERENCES `tour` (`tour_id`) ON DELETE CASCADE ON UPDATE CASCADE;
